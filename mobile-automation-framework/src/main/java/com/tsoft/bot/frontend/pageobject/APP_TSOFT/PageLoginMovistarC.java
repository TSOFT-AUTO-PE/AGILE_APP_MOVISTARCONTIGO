...
public class PageLoginMovistarC {
    ...
    private static final String COLUMNA_CODVERIFICACION1 = "CodVer1"; // COLUMNA DEL COD 1
    private static final String COLUMNA_CODVERIFICACION2 = "CodVer2"; // COLUMNA DEL COD 2
    private static final String COLUMNA_CODVERIFICACION3 = "CodVer3"; // COLUMNA DEL COD 3
    private static final String COLUMNA_CODVERIFICACION4 = "CodVer4"; // COLUMNA DEL COD 4
    ...
    //SELECCION DE PAISES
    public static String SELEC_PAIS         = "pe.com.qallarix.movistarcontigo:id/tviCountry";  //idCountry
    public static String OPCION_PERU        = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.TextView";
    public static String OPCION_COSTARICA   = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.TextView";
    public static String OPCION_ELSALVADOR  = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[3]/android.widget.TextView";
    public static String OPCION_VENEZUELA   = "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[4]/android.widget.TextView";
    public static String BTN_SIGUIENTE1      = "pe.com.qallarix.movistarcontigo:id/login_btIngresar_country"; //BOTON SIGUIENTE1

    public static String TXT_DOCUMENTO      = "pe.com.qallarix.movistarcontigo:id/eteEmail"; //NRO_DNI
    public static String BTN_SIGUIENTE2     = "pe.com.qallarix.movistarcontigo:id/login_btIngresar_country"; //BOTON_SIGUIENTE2
    public static String BTN_ACEPTAR        = "pe.com.qallarix.movistarcontigo:id/btnOk"; //BOTON_ACEPTAR
...
//    LUGAR Y SEDE DE PERU Y MEDIA NETWORKS
    ...
    public static void Seleccionar_Pais() throws Exception
    {
        try{
            driver.findElement(By.id(SELEC_PAIS)).click();
            driver.findElement(By.xpath(OPCION_PERU)).click();
            Thread.sleep(5000);

            driver.findElement(By.id(BTN_SIGUIENTE1)).click();

            ExtentReportUtil.INSTANCE.stepPass(driver, "Se seleccionó un país");
            generateWord.sendText("Se seleccionó un país");
            generateWord.addImageToWord(driver);
    ...
    public static void Clic_Boton_Siguiente2() throws Exception
    {
        driver.findElement(By.id(BTN_SIGUIENTE2)).click();
    }
    ...
    public static void Clic_Boton_Aceptar_Terminos_Condiciones() throws Exception
    {
        try
        {
            ...
            driver.findElement(By.id(BTN_ACEPTAR)).click();
            Thread.sleep(5000);
    ...
    public static void Ingresar_CodigoVerificacion(String casoDePrueba) throws Throwable
    {
        try{
            int valores = Integer.parseInt(casoDePrueba) - 1;
            String numCodVerificacion1 = getData1().get(valores).get(COLUMNA_CODVERIFICACION1);
            String numCodVerificacion2 = getData1().get(valores).get(COLUMNA_CODVERIFICACION2);
            String numCodVerificacion3 = getData1().get(valores).get(COLUMNA_CODVERIFICACION3);
            String numCodVerificacion4 = getData1().get(valores).get(COLUMNA_CODVERIFICACION4);
            String numCodVerificacion5 = getData1().get(valores).get(COLUMNA_CODVERIFICACION5);

            driver.findElement(By.xpath(TXT_COD1)).sendKeys(numCodVerificacion1);
            driver.findElement(By.xpath(TXT_COD2)).sendKeys(numCodVerificacion2);
            driver.findElement(By.xpath(TXT_COD3)).sendKeys(numCodVerificacion3);
            driver.findElement(By.xpath(TXT_COD4)).sendKeys(numCodVerificacion4);
            driver.findElement(By.xpath(TXT_COD5)).sendKeys(numCodVerificacion5);

            ExtentReportUtil.INSTANCE.stepPass(driver, "Se ingresó el código de verificación: " + numCodVerificacion1 + numCodVerificacion2 + numCodVerificacion3 + numCodVerificacion4 + numCodVerificacion5);
            generateWord.sendText("Se ingresó el código de verificación: " + numCodVerificacion1 + numCodVerificacion2 + numCodVerificacion3 + numCodVerificacion4 + numCodVerificacion5);
            generateWord.addImageToWord(driver);
...
//    ------------------------ FLUJO CORREO ELECTRONICO --------------------------------
    ...
    public static void Seleccionar_Paises(String paises) throws Throwable
    {
        try{
            ...
            switch(paisData)
            {
                case "Peru": driver.findElement(By.id(SELEC_PAIS)).click();
                    driver.findElement(By.xpath(OPCION_PERU)).click();
                    break;

                case "Costa Rica": driver.findElement(By.id(SELEC_PAIS)).click();
                driver.findElement(By.xpath(OPCION_COSTARICA)).click();
                break;

                case "El Salvador": driver.findElement(By.id(SELEC_PAIS)).click();
                driver.findElement(By.xpath(OPCION_ELSALVADOR)).click();
                break;

                case "Venezuela": driver.findElement(By.id(SELEC_PAIS)).click();
                driver.findElement(By.xpath(OPCION_VENEZUELA)).click();
                break;
    ...
    public static void Ingreso_DNI(String casoDePrueba) throws Throwable
    {
        try{
            ...
            driver.findElement(By.id(TXT_DOCUMENTO)).sendKeys(dniData);
            Thread.sleep(5000);
    ...
    public static void Ingresar_CodigoVerificacion_Correo(String casoDePrueba) throws Throwable
    {
        try{
            int valores = Integer.parseInt(casoDePrueba) - 1;
            String numCodVerificacion1 = getData3().get(valores).get(COLUMNA_CODVERIFICACION1);
            String numCodVerificacion2 = getData3().get(valores).get(COLUMNA_CODVERIFICACION2);
            String numCodVerificacion3 = getData3().get(valores).get(COLUMNA_CODVERIFICACION3);
            String numCodVerificacion4 = getData3().get(valores).get(COLUMNA_CODVERIFICACION4);
